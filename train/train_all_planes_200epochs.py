# train_all_planes.py — Entrena axial, coronal y sagital. Ensemble opcional.

# Entrena los tres planos y luego hace ensemble
# python train_all_planes.py --ensemble

# Entrena solo axial y coronal, sin ensemble
# python train_all_planes.py --planes axial coronal

# Solo ensemble (si ya entrenaste modelos)
# python train_all_planes.py --ensemble --planes axial coronal sagittal

# Ejemplo de uso con todo activado
# python train_all_planes.py --ensemble --gaussian-noise
...
if __name__ == "__main__":
    ...
    print(f"\n⏱️ Tiempo total de entrenamiento: {str(duration)}", flush=True)
